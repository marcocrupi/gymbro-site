export default function PrivacyEs() {
  ...
  return (
    <div className="container privacy">
      ...
      <p>
        <strong>IMPORTANTE:</strong> la app está destinada a usuarios de 13 años
        o más. No se permite el uso de la app a menores de 13 años.
      </p>
      <p>
      ...
      <h2>2. Menores</h2>
      <p>
        <strong>Menores de 13 años:</strong> GymBroTools no está destinada a
        menores de 13 años y no recopilamos intencionadamente datos personales
        de niños menores de esa edad. Si un padre o tutor considera que un menor
        de 13 años ha proporcionado datos personales a través de la app, le
        invitamos a contactarnos inmediatamente a{" "}
        <a href="mailto:marcocrupi@hotmail.it">marcocrupi@hotmail.it</a> para
        solicitar su eliminación.
      </p>
      <p>
        <strong>Usuarios de 13 a 17 años:</strong> los menores de edad (13-17
        años) pueden utilizar la app. Se recomienda la supervisión de un padre o
        tutor para garantizar un uso responsable de la aplicación.
      </p>

      <h2>3. Tipos de datos recopilados</h2>
      <p>
      ...
      <p>
        ...
        solicita ni recopila datos personales «sensibles» o biológicos como
        fotos, ubicación GPS, contactos u otros datos no necesarios para el uso
        de la app, con la excepción de los datos de salud y actividad física
        que el usuario puede compartir opcionalmente a través de la integración
        con Apple Health (HealthKit) o Health Connect descrita en la
        Sección 4.
      </p>
      <p>
      ...
      <h2>4. Datos de salud y actividad física</h2>
      <p>
        GymBroTools ofrece una integración opcional con Apple Health (HealthKit)
        en iOS y Health Connect en Android, que permite a los usuarios
        sincronizar datos de salud y actividad física entre GymBroTools y la
        plataforma de salud de su dispositivo. Esta integración es totalmente
        opcional y requiere el consentimiento explícito del usuario, otorgado a
        través del diálogo nativo de permisos del sistema operativo.
      </p>
      <p>
        <strong>
          Datos que podemos leer de la plataforma de salud del dispositivo:
        </strong>
        {" "}peso corporal, altura, porcentaje de grasa corporal y masa magra.
        Estos datos pueden proceder de otros dispositivos o apps (p. ej.,
        básculas inteligentes) conectados a la plataforma de salud.
      </p>
      <p>
        <strong>
          Datos que podemos escribir en la plataforma de salud del dispositivo:
        </strong>
        {" "}peso corporal, altura, porcentaje de grasa corporal, masa magra,
        IMC (Índice de Masa Corporal), TMB (Tasa Metabólica Basal) y
        circunferencia de cintura; sesiones de entrenamiento que incluyen tipo
        de ejercicio, duración, calorías quemadas, distancia y frecuencia
        cardíaca cuando esté disponible.
      </p>
      <p>
        <strong>Finalidades del tratamiento de datos de salud:</strong> los
        datos de salud se utilizan exclusivamente para (a) importar mediciones
        corporales desde dispositivos externos (p. ej., básculas inteligentes)
        para consolidarlas en el perfil fitness del usuario dentro de
        GymBroTools; (b) exportar entrenamientos y mediciones corporales
        registrados en la app hacia la plataforma de salud del dispositivo,
        para que estén disponibles en una ubicación centralizada; y (c) calcular
        métricas derivadas como el IMC, el FFMI (Índice de Masa Libre de
        Grasa) y la relación cintura‑altura.
      </p>
      <p>
        <strong>Base jurídica (art. 9 GDPR):</strong> los datos de salud
        constituyen una «categoría especial» de datos personales según el
        art. 9 del GDPR. La base jurídica para el tratamiento de estos datos
        es el consentimiento explícito del usuario (art. 9(2)(a) GDPR),
        obtenido a través del diálogo nativo de permisos del sistema operativo
        (pantalla de permisos de Apple Health en iOS; pantalla de permisos de
        Health Connect en Android). Los permisos son granulares: el usuario
        puede autorizar o denegar el acceso a cada tipo de dato de forma
        independiente. Solo se solicitan los tipos de datos estrictamente
        necesarios para proporcionar las funciones de integración fitness,
        conforme al principio de minimización de datos.
      </p>
      <p>
        <strong>Conservación y compartición:</strong> los datos de salud
        sincronizados a través de Apple Health o Health Connect se transmiten
        a los servidores de GymBroTools como parte de las mediciones corporales
        del usuario, protegidos mediante autenticación y cifrado en tránsito
        (HTTPS). Los datos de salud <strong>no</strong> se venden a terceros,
        no se comparten con terceros con fines publicitarios o de marketing, no
        se utilizan para perfilado ni se emplean para ningún fin distinto de
        las funcionalidades de la app descritas anteriormente.
      </p>
      <p>
        <strong>Control del usuario:</strong> la sincronización de datos de
        salud está desactivada por defecto. El usuario puede activarla o
        desactivarla en cualquier momento desde los Ajustes de la app. En iOS,
        los permisos de Apple Health pueden gestionarse desde Ajustes &gt;
        Salud &gt; Acceso a datos y dispositivos. En Android, el usuario puede
        revocar los permisos de Health Connect directamente desde los ajustes
        del dispositivo (Ajustes &gt; Health Connect &gt; Permisos de apps).
        Tras la revocación, GymBroTools dejará de leer y escribir datos de
        salud. La eliminación de la cuenta conlleva la supresión de todos los
        datos de los servidores de GymBroTools; los datos ya escritos en Apple
        Health o Health Connect permanecen bajo el control del usuario en su
        propio dispositivo.
      </p>
      <p>
        <strong>Cumplimiento de las plataformas:</strong> GymBroTools cumple
        con las directrices de Apple para el uso de HealthKit y con las
        políticas de Google para desarrolladores de Health Connect. Los datos
        de salud se tratan de conformidad con el GDPR, las leyes aplicables
        en materia de protección de datos de salud y los requisitos específicos
        de las plataformas para aplicaciones que acceden a datos sanitarios.
      </p>
      ...
      <h2>7. Modalidades del tratamiento y plazos de conservación</h2>
      <p>
      ...
      <h2>9. Seguridad y protección de los datos</h2>
      <p>
      ...
      <h2>10. Responsable del tratamiento y contacto</h2>
      <p>
      ...
      <h2>
        11. Modificaciones y actualizaciones de esta Política de Privacidad
      </h2>
      <p>
