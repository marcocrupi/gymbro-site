  ...
  return (
    <div className="container terms">
      ...
      <p>
        ...
        GymBroTools, vous déclarez avoir au moins 13 ans et posséder la capacité
        d'accepter les présentes Conditions.
      </p>
      <p>
        Le Titulaire ne collecte pas intentionnellement de données concernant
        les enfants de moins de 13 ans et ne leur fournit pas de services. S'il
        apparaît qu'un enfant de moins de 13 ans utilise l'App, le Titulaire
        peut prendre les mesures appropriées, y compris la suppression du compte
        associé.
      </p>
      <p>
        Les utilisateurs de 13 à 17 ans peuvent utiliser librement l'App. Une
        supervision parentale ou d'un tuteur est recommandée pour garantir une
