...
const translations: Translations = {
  en: {
    ...
    'landing.cta.googlePlay': 'Get it on Google Play',
    'landing.cta.appStore': 'Download on App Store',
    'landing.cta.comingSoon': 'Coming Soon',
    'landing.link.telegram': 'Telegram Channel',
  ...
  it: {
    ...
    'landing.link.telegram': 'Canale Telegram',
    'landing.link.privacy': 'Privacy policy',
  ...
  es: {
    ...
    'landing.cta.googlePlay': 'Descargar en Google Play',
    'landing.cta.appStore': 'Descargar en App Store',
    'landing.cta.comingSoon': 'Próximamente',
    'landing.link.telegram': 'Canal de Telegram',
  ...
  fr: {
    ...
    'landing.cta.googlePlay': 'Télécharger sur Google Play',
    'landing.cta.appStore': "Télécharger sur l'App Store",
    'landing.cta.comingSoon': 'Bientôt disponible',
    'landing.link.telegram': 'Chaîne Telegram',
  ...
  pt: {
    ...
    'landing.cta.googlePlay': 'Baixar na Google Play',
    'landing.cta.appStore': 'Baixar na App Store',
    'landing.cta.comingSoon': 'Em breve',
    'landing.link.telegram': 'Canal do Telegram',
  ...
  de: {
    ...
    'landing.cta.googlePlay': 'Bei Google Play herunterladen',
    'landing.cta.appStore': 'Im App Store laden',
    'landing.cta.comingSoon': 'Demnächst verfügbar',
    'landing.link.telegram': 'Telegram-Kanal',
